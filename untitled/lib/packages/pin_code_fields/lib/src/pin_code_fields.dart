...
class _PinCodeTextFieldState extends State<PinCodeTextField>
  ...
  List<Color> _getColorsFromIndex(int index) {
    if (!widget.enabled) {
      return [_pinTheme.disabledColor, _pinTheme.disabledColor];
    }
    if (((_selectedIndex == index) ||
            (_selectedIndex == index + 1 && index + 1 == widget.length)) &&
        _focusNode!.hasFocus) {
      return [AppTheme.blue50, AppTheme.blue50];
    ...
    return [relevantInActiveColor, relevantInActiveColor];
  }
